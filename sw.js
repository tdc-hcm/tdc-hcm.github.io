...
var CACHE_NAME = 'bc-tdc-shell-v4'; // v3 -> v4 — bỏ hẳn cache "hiện cũ trước" cho Tab Dự án/Bộ
                                     // phận (rủi ro hiện báo cáo lỗi thời), đổi logo, chuyển nút
                                     // zoom — cần áp dụng ngay cho ai đã cài app từ trước.
